...
class KeyWindow:
    ...
    def display_key_window(self):
        ...
        self.key_window.configure(bg="#1F1F1F")  # Dark background

        # Main Frame
        frame = Frame(self.key_window, bg="#2E2E2E", padx=20, pady=20)  # dark-grey background for frame
